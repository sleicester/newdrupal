...
*  
*  var hex  = "#000000",
*      rgb  = hexToRgb(hex), // returns rgb.r, rgb.g, rgb.g
*      cmyk = ColorConverter.toCMYK(new RGB(rgb.r, rgb.g, rgb.b)); // returns cmyk.c, cmyk.m, cmyk.y, cmyk.k
*
**/
  ...
  $('.cl-colours li').each(function() {
    console.log($(this).find('.hex').html());
    var hex = "#" + $(this).find('.hex').html(),
        rgb = hexToRgb(hex),
        cmyk= ColorConverter.toCMYK(new RGB(rgb.r, rgb.g, rgb.b)),
        hsv = ColorConverter.toHSV(new RGB(rgb.r, rgb.g, rgb.b));

    //$(this).find('.rgb').html(rgb.r +"/"+ rgb.g +"/"+ rgb.b);
    //$(this).find('.cmyk').append("<br>" + hsv.h +"/"+ hsv.s +"/"+ hsv.v + "<br>" + cmyk.c +"/"+ cmyk.m +"/"+ cmyk.y + "/" + cmyk.k);
