...
// ----------------------------------------------------------
// v2.1
// Split out the property bool for activating active item
// ----------------------------------------------------------
...
(function($, window, df, undefined){
    ...
    df.PrimaryNavigation.prototype = {
        version: 'OU.DigitalFramework.Global.PrimaryNavigation | v2.1',
        defaults: {
            ...
            activeItem: false,
            activeItemClass: $('body').data('page-id'),
            aria: true
        },
        setActiveItems: function(o){
            if(o.activeItem){
                $('.' + o.activeItemClass).closest('li').addClass('int-nav-active');
            }
            return this;
        },
        ...
        init: function () {
            ...
            this.setActiveItems(o)
                .responsiveNavClickHandlers(showMobileNav)
...
//OU.PrimaryNavigation = new OU.DigitalFramework.Global.PrimaryNavigation({}); //This should be called within the page. Pass in an object literal to override the defaults.