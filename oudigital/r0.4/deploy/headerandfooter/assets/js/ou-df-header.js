...
function ou_search() {
    ...
    $_headerSearchVal = document.getElementById("headerSearch");
    if($_headerSearchVal.value) {
        window.location.href = 'http://search.open.ac.uk/public/search/results?q=' + $_headerSearchVal.value;
    }
}
...
var ou_ca_pub = ["www", "www3", "www2", "www8", "css2", "css3", "msds", "search", "students"],
    ...
    ou_ca_test = ["msds-acct", "gaffer", "www3-acct", "css2-acct", "pccs1523", "csintra1", "learnacct", "learn2acct", "learn3acct", "learn4acct", "www-acct", "www8-acct", "www2-acct", "cms-test", "www-dev"],
